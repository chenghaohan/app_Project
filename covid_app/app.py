...
def provcovidRoute(): 
    ...
    output = [{ "Province": ont_prov_data, "cases": ont_cases_data, "deaths": ont_deaths_data, "vaccines": ont_vaccine_data, "coordinates": ont_coor_data }, { "Province": bc_prov_data, "cases": bc_cases_data, "deaths": bc_deaths_data, "vaccines": bc_vaccine_data, "coordinates": bc_coor_data}, 
                { "Province": yk_prov_data,"cases": yk_cases_data, "deaths": yk_deaths_data, "vaccines": yk_vaccine_data, "coordinates": yk_coor_data} , { "Province": nwt_prov_data,"cases": nwt_cases_data, "deaths": nwt_deaths_data, "vaccines": nwt_vaccine_data, "coordinates": nwt_coor_data}, 
                { "Province": nv_prov_data, "cases": nv_cases_data, "deaths": nv_deaths_data, "vaccines": nv_vaccine_data, "coordinates": nv_coor_data} , { "Province": ab_prov_data,"cases": ab_cases_data, "deaths": ab_deaths_data, "vaccines": ab_vaccine_data, "coordinates": ab_coor_data}, 
                { "Province": sw_prov_data,"cases": sw_cases_data, "deaths": sw_deaths_data, "vaccines": sw_vaccine_data, "coordinates": sw_coor_data}, {  "Province": mb_prov_data,"cases": mb_cases_data, "deaths": mb_deaths_data, "vaccines": mb_vaccine_data, "coordinates": mb_coor_data}, 
                { "Province": qb_prov_data,"cases": qb_cases_data, "deaths": qb_deaths_data, "vaccines": qb_vaccine_data, "coordinates": qb_coor_data}, { "Province": nl_prov_data,"cases": nl_cases_data, "deaths": nl_deaths_data, "vaccines": nl_vaccine_data, "coordinates": nl_coor_data}, 
                { "Province": pei_prov_data,"cases": pei_cases_data, "deaths": pei_deaths_data, "vaccines": pei_vaccine_data, "coordinates": pei_coor_data}, { "Province": nb_prov_data,"cases": nb_cases_data, "deaths": nb_deaths_data, "vaccines": nb_vaccine_data, "coordinates": nb_coor_data}, 
                { "Province": ns_prov_data,"cases": ns_cases_data, "deaths": ns_deaths_data, "vaccines": ns_vaccine_data, "coordinates": ns_coor_data} ]
